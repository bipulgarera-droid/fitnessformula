...
const Footer: React.FC<FooterProps> = ({
  businessName = 'FITNESS FORMULA 1',
  address = 'We are based out of Delhi.',
  email = 'info@fitnessformula1.com',
  phone = '+91 8800847288',
  slug,
  onAdminClick
}) => {
      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Your premier destination for customized diet plans and fitness transformation. Follow your gut with our expert nutritionists.
          </p>
        </div>
